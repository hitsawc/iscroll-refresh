...
var iScrollRefresh = function(tab_id, bd_id, parames) {
  ...
  var downTipClassName = 'ir-down-tip',
  ...
  function createScroll() {
    ...
    tabsScroll = new IScroll(_this.tabWrapper, {
      scrollX: true,
      scrollY: false,
      snap: tagName,
      tap: true
    ...
    for (i = 0; i < warppers.length; i++) {
      ...
      bdScrolls[i] = new IScroll(warppers[i], {
        probeType: 3,
        tap: true
      });
      //添加下拉刷新DIV
    ...
    bdScroll = new IScroll(_this.bdWrapper, {
      scrollX: true,
      scrollY: false,
      momentum: false,
      snap: true
